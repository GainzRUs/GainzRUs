...
import static nl.dionsegijn.konfetti.core.models.Shape.Circle;
import static nl.dionsegijn.konfetti.core.models.Shape.DrawableShape;
import static nl.dionsegijn.konfetti.core.models.Shape.Square;
...
public class StatsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrawableShape drawableShape = new DrawableShape(AppCompatResources.getDrawable(this, R.drawable.ic_confetti1), true);

        button.setOnClickListener(view -> {
            EmitterConfig emitterConfig = new Emitter(300, TimeUnit.MILLISECONDS).max(300);
            konfettiView.start(
                    new PartyFactory(emitterConfig)
                            .shapes(Circle.INSTANCE, Square.INSTANCE, drawableShape)
                            .spread(360)
